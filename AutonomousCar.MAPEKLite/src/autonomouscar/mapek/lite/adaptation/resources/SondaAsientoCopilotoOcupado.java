...
public class SondaAsientoCopilotoOcupado extends Probe {
	...
	public SondaAsientoCopilotoOcupado(BundleContext context) {
		super(context, ID);
	}

	public SondaAsientoCopilotoOcupado setPeriodMillis(long ms) {
	...
	public void update() {
		...
		if (hs == null)
			return;
		this.reportIfChanged(Boolean.valueOf(hs.isCopilotSeatOccupied()));
	}
	...
	public void startMonitoring() {
		...
		}, "SondaAsientoCopilotoOcupado-Worker");
