...
public class MonitorAsientoCopilotoOcupado extends Monitor {

	public static String ID = "monitor-asiento-copiloto-ocupado";
	public static String KNOWLEDGE_PROPERTY = "asiento-copiloto-ocupado";

	public MonitorAsientoCopilotoOcupado(BundleContext context) {
		super(context, ID);
	}
