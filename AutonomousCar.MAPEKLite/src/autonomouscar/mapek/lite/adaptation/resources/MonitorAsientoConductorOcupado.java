...
public class MonitorAsientoConductorOcupado extends Monitor {

	public static String ID = "monitor-asiento-conductor-ocupado";
	public static String KNOWLEDGE_PROPERTY = "asiento-conductor-ocupado";

	public MonitorAsientoConductorOcupado(BundleContext context) {
		super(context, ID);
	}
